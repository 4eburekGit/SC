...
Проблема:
    Чикакгский Музей Искусств является очень крупным музеем, содержащим порядка 100 тысяч различных предметов искусства, информацию о которых можно получить с их открытого API, но данные и фотографии разбросаны по разным источникам, что сильно усложняет просмотр предметов искусства.
Решение:
